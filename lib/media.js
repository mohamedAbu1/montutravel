...
export function resolveTravelImage(source, { kind = "trip", label = "", index = 0 } = {}) {
  ...
  if (text.includes("temple") || text.includes("edfu") || text.includes("dendera") || text.includes("luxor")) return "/Luxor/pexels-oualid-soussi-2150533856-35050672.webp";
  if (text.includes("nile") || text.includes("aswan")) return "/Nile_Cruise/pexels-sahilcaptures-35645491.webp";
